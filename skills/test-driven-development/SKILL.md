...
**In-repo touchpoints** — sections this skill owns or extends: Overview, When to Use, The TDD Cycle, Step 1: RED — Write a Failing Test.

**Boundary case** — when the request only names a trigger without the artifact it acts on, route to the owning surface instead of improvising here.
## Guidelines

1. Write the minimum code to make the test pass. Don't over-engineer:
2. // (Don't do this just to avoid repeating the input shape)
