...
## 2026-09-18 drift check (wayfinder round 8, cycle 73)

metrics and reporting record: this round's ledger discipline (counts only, no rates) is the doc's own reporting rule applied; note additive.
